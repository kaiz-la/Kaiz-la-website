...
import { ArrowRight, Compass, Handshake, Globe2, ShieldCheck, Ship } from "lucide-react"
 ...
 */
export default function SourcingGuides({ showHeader = true }: { showHeader?: boolean }) {
  return (
