        ...
        {carousel ? (
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
            ...
            {showAskCard && (
              <Link
                href="/chat"
                className="focus-ring group relative flex h-full flex-col justify-between overflow-hidden rounded-2xl border border-crimson/25 bg-crimson/[0.04] p-5 transition duration-200 hover:-translate-y-1 hover:border-crimson/45 hover:shadow-lift-lg active:translate-y-0 active:scale-[0.99] sm:p-6"
              >
                <span className="absolute inset-x-0 top-0 h-1 bg-sun-gradient" />
                <div>
                  <div className="flex items-start gap-4 sm:block">
                    <div className="flex h-11 w-11 flex-shrink-0 items-center justify-center rounded-xl bg-crimson text-white shadow-sm sm:mb-5 sm:h-12 sm:w-12">
