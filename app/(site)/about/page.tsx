...
export const metadata: Metadata = {
  ...
  description:
    "Kaiz La is a sourcing-as-a-service company headquartered in Shenzhen, China, with 15+ years of expertise connecting businesses across India and the Middle East with vetted Chinese suppliers.",
