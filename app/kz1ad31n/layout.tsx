      ...
      <header className="border-b border-border bg-white">
        <div className="mx-auto flex max-w-5xl items-center justify-between px-5 py-4 sm:px-6">
          <div className="flex items-center gap-6">
            <Link href="/kz1ad31n" className="flex items-center gap-2">
            ...
            <nav className="flex items-center gap-4 text-sm font-semibold">
              <Link href="/kz1ad31n" className="text-ink transition-colors hover:text-crimson">
                Shipments
              </Link>
              <Link href="/kz1ad31n/leads" className="text-ink transition-colors hover:text-crimson">
                Leads
              </Link>
            </nav>
          </div>
          <a
            href="/kz1ad31n/logout"
